...
namespace WebApplication.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller("Marian Green", "maria@gmail.com", new DateTime(1979, 7, 10), 3500.0, d2);
            Seller s3 = new Seller("Alex Grey", "alex@gmail.com", new DateTime(1985, 1, 11), 2200.0, d1);
            Seller s4 = new Seller("Martha Red", "martha@gmail.com", new DateTime(1993, 6, 16), 3000.0, d4);
            Seller s5 = new Seller("Donald Blue", "donald@gmail.com", new DateTime(2000, 10, 1), 4000.0, d3);
            Seller s6 = new Seller("Alex Pink", "pink@gmail.com", new DateTime(1975, 3, 4), 3000.0, d2);
